    ...
    <div>
      ...
      <section id="tela1">
        <div className="hero-content">
          ...
          <button className="botao-gradiente" onClick={() => navigate("/login")}>Começar agora</button>
        </div>
      ...
      <div className="white box1">
        ...
        <div className="right">
          ...
          <div className="imgset2">
            <img className="absolute2 icon float" src={backgoal1} alt="" draggable="false"
              style={{ userDrag: "none", WebkitUserDrag: "none" }} />
            <img className="absolute2 icon float" src={spark} alt="" draggable="false"
              style={{ userDrag: "none", WebkitUserDrag: "none" }} />
            <img className="absolute2 icon float" src={goal2} alt="" draggable="false"
              style={{ userDrag: "none", WebkitUserDrag: "none" }} />
            <img className="absolute2 icon float" src={goal1} alt="" draggable="false"
              style={{ userDrag: "none", WebkitUserDrag: "none" }} />
          </div>
        </div>
